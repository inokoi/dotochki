...
class CI_Form_validation {
	...
	function alpha2($str)
	{
		return ( ! preg_match("/^([a-zA-Zà-ÿÀ-ß\ \¸])+$/i", $str)) ? FALSE : TRUE;
	}
	 ...
	 * @return	bool
	 */	
	function alpha2_numeric($str)
	{
		return ( ! preg_match("/^([a-zA-Zà-ÿÀ-ß0-9\ \¸])+$/i", $str)) ? FALSE : TRUE;
	}
	 ...
	 * @return	bool
	 */	
	function alpha2_dash($str)
	{
		return ( ! preg_match("/^([-a-zA-Zà-ÿÀ-ß0-9\+\,\.\_\-\n\ \¸])+$/i", $str)) ? FALSE : TRUE;
	}
