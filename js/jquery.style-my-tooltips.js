//Плагин style-my-tootltips Автор: malihu (http://manos.malihu.gr)
//Домашняя страница http://manos.malihu.gr/style-my-tooltips-jquery-plugin
(function($){
  $.fn.style_my_tooltips = function(options) {  
    ...
    return this.each(function() {  
		...
		function smtTipPosition(){
			var cursor_tip_margin_x=12;  //Промежуток по горизонтали между курсором и подсказкой
