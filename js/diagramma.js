...
function pieChart() {
  ...
  var maxPullOutDistance = 15;                      // Насколько далеко будет выдвигаться сектор из диаграммы
  var pullOutFrameStep = 2;                         // На сколько пикселей Hеперемещается сектор в каждом кадре анимации
  var pullOutFrameInterval = 40;                    // Сколько ms проходит между кадрами
  var pullOutLabelPadding = 60;                     // Отступ между выдвинутым сектором и его меткой
  var pullOutLabelFont = "12px 'Trebuchet MS', Verdana, sans-serif";  // Шрифт метки выдвинутого сектора
  var pullOutValueFont = "12px 'Trebuchet MS', Verdana, sans-serif";  // Шрифт значения выдвинутого сектора
  ...
  function handleChartClick ( clickEvent ) {
    ...
    var mouseY = clickEvent.pageY - this.offsetTop - 170;
