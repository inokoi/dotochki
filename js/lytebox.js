...
Lytebox.prototype.changeContent = function(iImageNum) {
	...
	if (this.navTypeHash['Display_by_type_' + this.navType] || this.isLyteframe) {
		...
		object.innerHTML = '&nbsp;&nbsp;&nbsp;<span id="lbPrev2_Off" style="display: none;" class="' + this.theme + '">&laquo; Предыдущая</span><a href="javascript:void(0);" id="lbPrev2" class="' + this.theme + '" style="display: none;">&laquo; Предыдущая</a> <b id="lbSpacer" class="' + this.theme + '"> &nbsp; &nbsp; &nbsp; </b> <span id="lbNext2_Off" style="display: none;" class="' + this.theme + '">Следующая &raquo;</span><a href="javascript:void(0);" id="lbNext2" class="' + this.theme + '" style="display: none;">Следующая &raquo;</a>';
...
Lytebox.prototype.updateDetails = function() {		
	...
	if (this.isSlideshow && this.slideArray.length > 1) {
		...
		object.style.display = '';
		object.innerHTML = "Фото  " + eval(this.activeImage + 1) + " из " + this.imageArray.length;
...
Lytebox.prototype.end = function(sCaller) {
	...
	this.doc.getElementById('lbOuterContainer').style.width = '400px';
	this.doc.getElementById('lbOuterContainer').style.height = '100px';
	if (this.isSlideshow) {
		for (var i = 0; i < this.slideshowIDCount; i++) { window.clearTimeout(this.slideshowIDArray[i]); }
	}
	if (this.isLyteframe) {
...
Lytebox.prototype.appear = function(sId, iOpacity) {		
	...
	object.KhtmlOpacity = (iOpacity / 1);
